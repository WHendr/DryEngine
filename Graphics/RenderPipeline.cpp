...
{
	RenderPipeline::RenderPipeline(LogicalDevice& in_logicalDevice, RenderPass& renderPass)
        :
        pipelineLayout{},
        graphicsPipeline{},
        logicalDevice(in_logicalDevice)
	{
        auto vertShaderCode = Dry::File::File::readFile("shaders/vert.spv");
        auto fragShaderCode = Dry::File::File::readFile("shaders/frag.spv");
	...
	{
        vkDestroyPipeline(this->logicalDevice.device, graphicsPipeline, nullptr);
        vkDestroyPipelineLayout(this->logicalDevice.device, pipelineLayout, nullptr);
	}
